...
@section('content')
    <header class="flex items-center mb-3 py-4">
        <div class="flex justify-between items-end w-full">
            ...
            <a href="{{url('/projects/create')}}" class="btn-blue">New Project</a>
        </div>
    </header>
    ...
    <modal name="hello-world" classes="p-10 bg-card rounded-lg" height="auto">
        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                <div class="mb-4">
                    ...
                    <input type="text" id="title" class="block w-full border border-muted-light p-2 text-xs rounded">
                </div>
                <div class="mb-4">
                    <label for="description" class="text-sm block mb-2">Description</label>
                    <textarea id="description" class="block w-full border border-muted-light p-2 text-xs rounded" rows="7"></textarea>
                </div>
            </div>
            <div class="flex-1 ml-4">
                <div class="mb-4">
                    <label class="text-sm block mb-2">Need Some Tasks?</label>
                    <input type="text" class="block w-full border border-muted-light p-2 text-xs rounded" placeholder="Task 1">
                </div>
        ...
        <footer class="flex justify-end">
            <button class="btn-blue is-outlined">Cancel</button>
            <button class="btn-blue ml-4">Create Project</button>
        </footer>
    </modal>
