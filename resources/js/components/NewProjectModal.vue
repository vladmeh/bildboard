    ...
    <modal name="new-project" classes="p-10 bg-card rounded-lg" height="auto">
        ...
        <form @submit.prevent="submit">
            <div class="flex">
                <div class="flex-1 mr-4">
                    <div class="mb-4">
                        ...
                        <input type="text"
                               id="title"
                               class="block w-full border p-2 text-xs rounded"
                ...
                <div class="flex-1 ml-4">
                    <div class="mb-4">
                        ...
                        <input type="text"
                               class="block w-full border border-muted-light mb-2 p-2 text-xs rounded"
                               placeholder="Task 1"
            ...
            <footer class="flex justify-end">
                <button type="button" class="btn-blue is-outlined" @click="$modal.hide('new-project')">Cancel</button>
